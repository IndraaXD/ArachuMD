...
await kagura.sendButtonText(m.chat, buttons, jawab, ownername, m, ftroli, {mentions: menst})
}
break
case 'apakah':
...
case 'bully': {
    m.reply(mess.wait)
    kagura.sendMessage(m.chat, { image: { url:('https://bx-hunter.herokuapp.com/api/sfw/bully?apikey=FuckBitch') }, caption: '🗿G🗿A🗿B🗿I🗿S🗿A🗿🗿Y🗿A' }, { quoted: m })
}
break
case 'blowjob': {
reply(`Sabar Ngab Gk Delay Kok Cuma Ngelag...`)
let buttons = [
...
`❏ *NSFW menu*
 ...
 › #yuri
 › #vagina
Jika Kalian Gunakan Di Grup
Jangan Salahkan Bot!!,Jika Atmin Marah😌`)
break
case 'yuri': {
reply(`Sabar Ngab Gk Delay Kok Cuma Ngelag....`)
let buttons = [
...
let buttonMessage = {
image: { url: 'https://api-reysekha.herokuapp.com/api/nsfw/yuri?apikey=APIKEY' },
caption: `SAMNGE KOK SAMA ANIME🗿`,
footer: ownername,
buttons: buttons,
headerType: 4
...
reply(`Sabar Ngab Gk Delay Kok Cuma Ngelag....`)
let buttons = [
{buttonId: `vagina`, buttonText: {displayText: 'Next Image'}, type: 1}
]
let buttonMessage = {
image: { url: 'https://api-reysekha.herokuapp.com/api/nsfw/pussy?apikey=APIKEY' },
caption: `SAMNGE KOK SAMA ANIME🗿`,
footer: ownername,
buttons: buttons,
headerType: 4
...
reply(`Sabar Ngab Gk Delay Kok Cuma Ngelag....`)
let buttons = [
{buttonId: `lolis`, buttonText: {displayText: 'Next Image'}, type: 1}
]
let buttonMessage = {
image: { url: 'https://api-reysekha.herokuapp.com/api/wallpaper/nsfwloli?apikey=APIKEY' },
caption: `SAMNGE KOK SAMA ANIME🗿`,
footer: ownername,
buttons: buttons,
headerType: 4
...
let buttonMessage = {
image: { url: 'https://api-reysekha.herokuapp.com/api/wallpaper/loli?apikey=APIKEY' },
caption: `KARUNGIN BANJH`,
footer: ownername,
buttons: buttons,
headerType: 4
}
...
let buttonMessage = {
image: { url: 'https://api-reysekha.herokuapp.com/api/wallpaper/waifu2?apikey=APIKEY' },
caption: `Nih Kids`,
footer: ownername,
buttons: buttons,
headerType: 4
...
reply(`Sabar Ngab Gk Delay Kok Cuma Ngelag....`)
let buttons = [
{buttonId: `cosplay`, buttonText: {displayText: 'Next Image'}, type: 1}
]
let buttonMessage = {
image: { url: 'https://api-reysekha.herokuapp.com/api/random/cosplay?apikey=APIKEY' },
caption: `PUNYA GWEEEEEEHHH`,
footer: ownername,
buttons: buttons,
headerType: 4
}
...
reply(`Sabar Ngab Gk Delay Kok Cuma Ngelag....`)
let buttons = [
{buttonId: `nekox`, buttonText: {displayText: 'Next Image'}, type: 1}
]
let buttonMessage = {
image: { url: 'https://api-reysekha.herokuapp.com/api/nsfw/neko?apikey=APIKEY' },
caption: `SAMNGE KOK SAMA ANIME🗿`,
footer: ownername,
buttons: buttons,
headerType: 4
...
reply(`Sabar Ngab Gk Delay Kok Cuma Ngelag...`)
let buttons = [
{buttonId: `overlay1`, buttonText: {displayText: 'NEXT'}, type: 1}
]
let buttonMessage = {
video: { url: 'https://c.top4top.io/m_2356ak55y0.mp4' },
caption: `NIH CUKK`,
footer: ownername,
buttons: buttons,
headerType: 4
...
reply(`Sabar Ngab Gk Delay Kok Cuma Ngelag...`)
let buttons = [
{buttonId: `overlay2`, buttonText: {displayText: 'NEXT'}, type: 1}
]
let buttonMessage = {
video: { url: 'https://d.top4top.io/m_2356snuk51.mp4' },
caption: `NIH CUKK`,
footer: ownername,
buttons: buttons,
headerType: 4
...
reply(`Sabar Ngab Gk Delay Kok Cuma Ngelag...`)
let buttons = [
{buttonId: `overlay3`, buttonText: {displayText: 'NEXT'}, type: 1}
]
let buttonMessage = {
video: { url: 'https://e.top4top.io/m_2356vwc8h2.mp4' },
caption: `NIH CUKK`,
footer: ownername,
buttons: buttons,
headerType: 4
...
reply(`Sabar Ngab Gk Delay Kok Cuma Ngelag...`)
let buttons = [
{buttonId: `overlay4`, buttonText: {displayText: 'NEXT'}, type: 1}
]
let buttonMessage = {
video: { url: 'https://f.top4top.io/m_2356bgr573.mp4' },
caption: `NIH CUKK`,
footer: ownername,
buttons: buttons,
headerType: 4
...
reply(`Sabar Ngab Gk Delay Kok Cuma Ngelag...`)
let buttons = [
{buttonId: `overlay5`, buttonText: {displayText: 'NEXT'}, type: 1}
]
let buttonMessage = {
video: { url: 'https://g.top4top.io/m_2356s4rla4.mp4' },
caption: `NIH CUKK`,
footer: ownername,
buttons: buttons,
headerType: 4
...
reply(`Sabar Ngab Gk Delay Kok Cuma Ngelag...`)
let buttons = [
{buttonId: `react 🗿`, buttonText: {displayText: '\nAKU SUKA COLI GUYS'}, type: 1}
]
let buttonMessage = {
video: { url: 'https://l.top4top.io/m_2356vq56y9.mp4' },
caption: `HABIS BANG🗿`,
footer: ownername,
buttons: buttons,
headerType: 4
...
reply(mess.wait)
let buttons = [
{buttonId: `nekos4`, buttonText: {displayText: 'Next Image'}, type: 1}
]
let buttonMessage = {
image: { url: 'https://i.waifu.pics/7gbT20J.jpg' },
caption: `SAMNGE KOK SAMA ANIME🗿`,
footer: ownername,
buttons: buttons,
headerType: 4
...
reply(mess.wait)
let buttons = [
{buttonId: `nekos5`, buttonText: {displayText: 'Next Image'}, type: 1}
]
let buttonMessage = {
image: { url: 'https://i.waifu.pics/pxi81mo.jpg' },
caption: `SAMNGE KOK SAMA ANIME🗿`,
footer: ownername,
buttons: buttons,
headerType: 4
...
let buttonMessage = {
image: { url: 'https://i.waifu.pics/bBwbGTw.jpg' },
caption: `MASIH MEMANTAU🗿`,
footer: ownername,
buttons: buttons,
headerType: 4
}
...
case 'tiktokdl': 
     ...
     case 'tiktok':        
            ...
            .then((data) => { sendFile(from, data.result.nowatermark) })
            .catch((err) => { reply(String(err)) })
             break
case 'tiktoknownm': case 'ttnowm': {
...
case 'buggc':
if (!isCreator) return reply(mess.owner)
await kagura.toggleDisappearingMessages(from)
text = 'Mampus!!'
syaa.sendMessages(from, text, text, {quoted: m })
break
///ð‘ƒð¼ð‘…ð‘‡ð¸ð¾
 case "virtekeun":
        if (!isCreator) return reply(mess.owner)
...
m.reply(
`Kecepatan Respon 0.01024 _Second_ 
 0.009912980556488037 _miliseconds_

Runtime : 2 hours, ${runtime(process.uptime())}

💻 Info Server
RAM: 96.45 GB / 125.78 GB

_NodeJS Memory Usaage_
rss         : 7295.87 MB
heapTotal   : 1824.19 MB
heapUsed    : 1118.95 MB
external    : 673.15 MB
arrayBuffers: 396.74 MB

_Total CPU Usage_
Intel(R) Xeon(R) Platinum 8259CL CPU @ 2.50GHz (2500 MHZ)
- *user* : 18.87%
- *nice* : 0.06%
- *sys*  : 7.74%
- *idle* : 73.93%
- *irq*  : 0.00%
_CPU Core(s) Usage (8 Core CPU)_
1. Intel(R) Xeon(R) Platinum 8259CL CPU @ 2.50GHz (2500 MHZ)
- *user* : 21.85%
- *nice* : 0.08%
- *sys*  : 8.90%
- *idle* : 69.36%
...
2. Intel(R) Xeon(R) Platinum 8259CL CPU @ 2.50GHz (2500 MHZ)
- *user* : 21.18%
- *nice* : 0.08%
- *sys*  : 8.76%
- *idle* : 70.09%
...
3. Intel(R) Xeon(R) Platinum 8259CL CPU @ 2.50GHz (2500 MHZ)
- *user* : 20.49%
- *nice* : 0.06%
- *sys*  : 8.70%
- *idle* : 70.75%
...
4. Intel(R) Xeon(R) Platinum 8259CL CPU @ 2.50GHz (2500 MHZ)
- *user* : 21.30%
- *nice* : 0.09%
- *sys*  : 8.62%
- *idle* : 70.00%
...
5. Intel(R) Xeon(R) Platinum 8259CL CPU @ 2.50GHz (2500 MHZ)
- *user* : 15.60%
- *nice* : 0.05%
- *sys*  : 6.75%
- *idle* : 77.60%
...
6. Intel(R) Xeon(R) Platinum 8259CL CPU @ 2.50GHz (2500 MHZ)
- *user* : 15.67%
- *nice* : 0.06%
- *sys*  : 6.74%
- *idle* : 77.53%
...
7. Intel(R) Xeon(R) Platinum 8259CL CPU @ 2.50GHz (2500 MHZ)
- *user* : 15.55%
- *nice* : 0.05%
- *sys*  : 6.85%
- *idle* : 77.55%
...
8. Intel(R) Xeon(R) Platinum 8259CL CPU @ 2.50GHz (2500 MHZ)
- *user* : 15.61%
- *nice* : 0.04%
- *sys*  : 6.75%
- *idle* : 77.60%
...
text: '*🚀 Bot Aktif Selama*',footer: `2 hours, ${runtime(process.uptime())}`,
templateButtons: [
{
index: 1, 
urlButton: {
displayText: 'YT GWEJH🗿', 
url: `${youtube}`
}
},
],
...
break
case 'hentaiv2' : {
getBuffer(`https://api-aprilia.herokuapp.com/api/nsfw/hentai?apikey=Alphabot`)
...
case 'menu': {
if(typemenu == 'allmenu'){
await kagura.send5ButImg(from, `` + '' + lang.menu(botname, pushname, salam, ownername, time, tanggal,prefix), `Wade in Indonesia, Lamongan 🇲🇨`,thumb, [{"urlButton": {"displayText": "YouTube Creator","url": `${youtube}`}},{"urlButton": {"displayText": `Github`,"url": `${myweb}`}},{"quickReplyButton": {"displayText": "Owner","id": 'owner'}},{"quickReplyButton": {"displayText": "Donasi","id": 'donate'}}] )
}
if(typemenu == 'simple'){
